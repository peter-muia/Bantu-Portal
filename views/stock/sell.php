      ...
      <div class="row mt-4">
        ...
        <div class="col-lg-8">
          ...
          <div class="card-header pb-0">
                  <h4>
                    <b>$168.54 </b>
                    <small>&nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-arrow-up text-success"></i>3.47% +5.65 5D </small>
                  </h4>
                  <p class="text-sm">
        ...
        <div class="col-lg-4 mb-lg-0 mb-4">
          <div class="card z-index-2">
            ...
            <div class="text-center">
              <button id="buy" class="badge badge-sm bg-gradient-success" style="float: left;">Buy Stock</button>
            </div>
            <div class="text-center">
              <button id="sell" class="badge badge-sm bg-gradient-info" style="float: right;">Sell Stock</button>
            </div>
              <div class="border-radius-lg py-3 pe-1 mb-3">
                <div class="card-body">
                  <!-- <form role="form">
                    ...
                    <div class="text-center">
                      <button type="button" class="btn bg-gradient-success w-100 mt-4 mb-0">Buy</button>
                    </div>
                  </form> -->
...
<div id="sell-content" style="display: none;">
  ...
  <form role="form">
    ...
    <div class="text-center">
      <button type="button" class="btn bg-gradient-info w-100 mt-4 mb-0">Sell</button>
    </div>
  </form>
</div>
