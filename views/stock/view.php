...
<html lang="en">
  ...
  <body class="g-sidenav-show  bg-gray-100">
          ...
          <div class="col-lg-8">
            <div class="card z-index-2">
              <div class="card-header pb-0 p-3">
                <h3><b> <?= $stock->name ?> </b></h3>
                <h4>
                  $<?= $stock->price ?>
                  <small style="font-weight:100;">&nbsp;&nbsp;&nbsp;&nbsp;<div class="arrow <?= $model->arrow == 'down' ? 'text-danger fa fa-arrow-down' : 'text-success fa fa-arrow-up' ?>"></div><?= $stock->percentage ?> </small>
                </h4>
                  ...
                  <div class="card-body">
                    <div id="buy-content">
                      ...
                      <form role="form" method="POST">
                        ...
                        <label>Price</label>
                        <div class="mb-3">
                          <input type="number" placeholder="$<?php echo $price; ?>" id="price" class="form-control" aria-label="number" aria-describedby="quantity-addon" disabled>
                        </div>
                        <label>Quantity</label>
                        <div class="mb-3">
                          <input type="number" id="quantity" class="form-control" placeholder="Quantity" aria-label="number" aria-describedby="quantity-addon" id="quantity"  onchange="calculateTotal()">
                        </div>
                    ...
                    <div id="sell-content" style="display: none;">
                      ...
                      <form role="form">
                        ...
                        <label>Quantity</label>
                        <div class="mb-3">
                          <input type="number" class="form-control" placeholder="Quantity" aria-label="number" aria-describedby="quantity-addon" id="quantity"  onchange="calculateTotal()">
                        </div>
                        <div id="total"></div>
                        <div class="text-center">
    ...
    function calculateTotal() {
        ...
        // Calculate the total
        var total = quantity * <?php echo $price; ?>;
