...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Callback</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      ...
      <center>
	      <div class="col-9">
              <p>To receive transaction notifications the instant they come into our api, you can register a Callback URL that will invoke whenever we receive a notification
	      for your transaction. Everytime a transaction status changes, we will forward you the details.</p></div>
          <div class="col-xl-6 col-sm-6 mb-xl-0 mb-4">
            <div class="#">
               ...
               <?php }
                ...
                <?php $form = ActiveForm::begin(['action' => '../settings/callback']); ?>
                <div class="row">
                  <?= $form->field($model, 'url')->textInput(['placeHolder' => "Enter Callback Url", 'value' => $callback, 'maxlength' => true, 'style' => 'border: 0.1px solid; border-color: #ddd; border-radius: 4px; padding: 24px;'])->label(false) ?>
