      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <center>
		<div class="col-9">
              <p>Please record the value you generate for later use as you will not see it from this dashboard on subsequent visits</p></div>
              <div class="col-xl-6 col-sm-6 mb-xl-0 mb-4">
                <div class="#">
		  <div class="card-body p-4">
		   <?php if($model['token'] == 'Pending') :?>
                    <?php $form = ActiveForm::begin(['action' => '../settings/token']); ?>
                    <div class="row">
                      ...
                      <div class="form-group">
                         <?= Html::submitButton('Generate', ['class' => 'btn btn-primary btn-button btn-block text-uppercase']) ?>
                      </div>
                    </div>
                    <?php ActiveForm::end(); ?>
	           <?php elseif($model["token"]) :?> 
	           <div>
	        	<b><?php echo $model["token"]; ?> </b>
	           </div> 
		    <?php else :?>
	            <?php $form = ActiveForm::begin(['action' => '../settings/token']); ?>
	            <div class="row">
	        	<?= $form->field($model, 'password')->passwordInput(['placeHolder'=>'Enter Password', 'style' => 'border: 0.1px solid; border-color: #ddd; border-radius: 4px; padding: 24px;'])->label(false) ?>
                      <div class="form-group">
