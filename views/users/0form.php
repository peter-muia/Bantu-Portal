...
$this->title = Yii::$app->user->identity->businessname;?>
    ...
    <div class="card ">
      ...
      <div class="card-body"> <?php $form = ActiveForm::begin([
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group bmd-form-group">
              <label for="<?=Html::getInputId($model, 'businessname');?>" class="bmd-label-floating"> <?=Html::activeLabel($model,'businessname');?> </label> <?= $form->field($model, 'businessname')->textInput(['maxlength' => true])->label(false); ?> <span class="bmd-help"> <?=Html::activeHint($model,'businessname');?> </span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group bmd-form-group">
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group bmd-form-group">
              <label for="<?=Html::getInputId($model, 'business_type');?>" class="bmd-label-floating"> <?=Html::activeLabel($model,'business_type');?> </label> <?= $form->field($model, 'business_type')->dropDownList([
                      'Limited Liability' => 'Limited Liability',
                      'NGO' => 'NGO',
                      'Partnership' => 'Partnership', 
                      'Sole Proprietorship' => 'Sole Proprietorship'])->label(false); ?> <span class="bmd-help"> <?=Html::activeHint($model,'business_type');?> </span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group bmd-form-group">
