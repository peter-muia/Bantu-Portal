...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700|Product+Sans:400,600,700" rel="stylesheet">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <h1 data-aos="fade-up">Hello   <?= Yii::$app->user->identity->businessname ?>!<br>
              
            </h1>

          <h4 data-aos="fade-up" data-aos-delay="400"><br/>Kindly give us 24 hours to verify your documents</h4>
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200" style="padding: 50px">
          ...
          <img src="/img/img/b2b.png" class="img-fluid" alt="">
