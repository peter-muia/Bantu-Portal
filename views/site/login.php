          ...
          <div class="row-login">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-0">
                ...
                <h3 class="font-weight-bolder" style="color: #000; font-family: Open Sans">Welcome back</h3>
                  <p class="mb-0">Enter your email and password to sign in</p>
                </div>
		<?php if (Yii::$app->session->hasFlash('error')): ?>
                  <div class="alert alert-danger" style="color: #fff; font-weight: bolder;">
                      <?= Yii::$app->session->getFlash('error') ?>
                  </div>
                <?php endif; ?>
                <?php if (Yii::$app->session->hasFlash('success')): ?>
                  <div class="alert alert-success" style="color: #fff; font-weight: bolder;">
                      <?= Yii::$app->session->getFlash('success') ?>
                  </div>
                <?php endif; ?>
                <?php if (Yii::$app->session->hasFlash('info')): ?>
                  <div class="alert alert-info" style="color: #fff; font-weight: bolder;">
                ...
                <?php $form = ActiveForm::begin([
                        ...
                        <?=isset($_COOKIE['rememberMe']) ? 'checked="checked"' : ''?>>
                        <label class="form-check-label" for="rememberMe">Remember me</label>
                       </div>

                        <div class="form-group">
                            <div class="">
                                <?= Html::submitButton('Sign In', ['class' => 'btn btn-login w-100 mt-4 mb-0', 'name' => 'login-button']) ?>
                            </div>
                        </div>
                        <div class="mt-4">
                            <!-- <div class="">
                            ...
                            <div class="d-flex justify-content-center links">
                                <a href="/site/request-password-reset">Forgot your password?</a>
                            </div>
