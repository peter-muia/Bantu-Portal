          ...
          <div class="row-login">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-0">
                ...
                <h3 class="font-weight-bolder" style="color: #000; font-family: Open Sans">Reset Password</h3>
                  <p class="mb-0">Fill in details to reset password:</p>
                </div>
                <div class="card-body">
                <?php $form = ActiveForm::begin([
                        ...
                        <?= $form->field($model, 'retypePassword')->passwordInput(['autofocus' => true])?>
                        <div class="form-group">
                            <?= Html::submitButton('Save', ['class' => 'btn btn-primary w-100 mt-4 mb-0']) ?>
                        </div>
                        <?php ActiveForm::end(); ?>
                </div>
              </div>
