          ...
          <div class="row-login">
            <div class="col-xl-6 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-0">
                ...
                <h3 class="font-weight-bolder" style="color: #000; font-family: Open Sans; text-align: center;">Reset password</h3>
                  <p class="mb-0">Please fill out your email. A link to reset password will be sent there.</p>
                </div>
                <div class="card-body">
