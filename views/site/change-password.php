      ...
      <div class="col-12">
	    ...
	    <div class="collapse navbar-collapse" id="navigation">
	      ...
	      <li class="navbar-item d-flex me-3">
                <a class="nav-login scrollto" href="/site/profile">Profile</a>
              </li>
              <li class="nav-item d-flex align-items-center">
                <a class="getstarted signup scrolto" href="/dashboard">Dashboard</a>
	      </li>
	      </div>
            </div>
          </div>
          ...
          <div class="row-login">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-0">
                ...
                <h3 class="font-weight-bolder" style="color: #000; font-family: Open Sans">Change <?php \Yii::$app->user->identity->firstname ?> Password</h3>
                  <p class="mb-0">Enter details below</p>
                </div>
                <div class="card-body">
                ...
                <div class="row">
                            <?php $form = ActiveForm::begin(['id' => 'form-change']); ?>
                                ...
                                <div class="form-group">
                                  <?= Html::submitButton('Confirm', ['class' => 'btn btn-primary w-100 mt-4 mb-0', 'name' => 'login-button']) ?>
