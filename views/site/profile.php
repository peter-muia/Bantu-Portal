        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              ...
              <li class="breadcrumb-item text-dark active" aria-current="page">Site</li>
            </ol>
            ...
            <div class="card mb-4">
              <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                  <h6>Profile </h6>
                  <div class="pull-right" style="float: right;"> <?= Html::a(Html::tag('b', 'back', ['class' => 'material-icons']) , ['../dashboard'], [
                  ...
                  <div class="customer-index"> <?= DetailView::widget([
	                      'model' => Yii::$app->user->identity,
                        'attributes' => [
                       [
                        	'label' => 'ID',
                          'attribute' => 'uuid',
		          'contentOptions' => ['class' => 'text-secondary font-weight-bold me-15'],
                       ],
                       [
                        'attribute' => 'phonenumber',
                        'contentOptions' => ['class' => 'text-secondary font-weight-bold me-15'],
                        'headerOptions' => ['class' => 'text-uppercase text-secondary text-monospace font-weight-bolder opacity-7'],
                       ],
                       [
                        'attribute' => 'firstname',
                        'contentOptions' => ['class' => 'text-secondary font-weight-bold me-15'],
                    ...
                    <p> 
                      ...
                      <a class="btn btn-secondary" href="/site/change-password">Change Password</a>
                    </p>
                  </div>
                </div>
              </div>
