...
<html lang="en">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a class="nav-link" href="/dashboard" style="list-style-type: none; margin-left: -8%;">
        ...
        <li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a class="nav-link" href="/investments" style="list-style-type: none; margin-left: -8%;">
		<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
	...
	<li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a class="nav-link" href="/distribution" style="list-style-type: none; margin-left: -8%;">
 		 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a id="admin" class="collapsible nav-link cursor-pointer" style="list-style-type: none; margin-left: -8%;">
            	 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
	     ...
	     </a>','url' => ['#'],'visible' => Yii::$app->user->can('admin')],
            ],
            'encodeLabels' => false,
            'options' => ['class' =>'nav-link'],
          ]); ?> </li>
        ...
        <li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a class="nav-link" href="/investors" style="list-style-type: none; margin-left: -8%;">
	  	 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a class="nav-link" href="/subscribers?admin=true" style="list-style-type: none; margin-left: -8%;">
            	 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
		...
		'visible' => Yii::$app->user->can('admin')
          ...
          <li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a class="nav-link" href="/topups?admin=true" style="list-style-type: none; margin-left: -8%;">
            	 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
		 ...
		 <span class="nav-link-text ms-1">Topups</span>
		 </a>','url' => ['/topups/index'],
		'visible' => Yii::$app->user->can('admin')
              ],
            ],
          ...
          <li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a class="nav-link" href="/users" style="list-style-type: none; margin-left: -8%;">
		 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
		  <svg class="text-dark" width="16px" height="16px" viewBox="0 0 46 42" version="1.1" 
		   xmlns="http://www.w3.org/2000/svg" 
		    xmlns:xlink="http://www.w3.org/1999/xlink"> 
        ...
        <li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a id="settings" class="collapsible nav-link cursor-pointer" style="list-style-type: none; margin-left: -8%;">
	 	 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div id="subsettings" class="submenu">
          <li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a class="nav-link" href="/settings/token" style="list-style-type: none; margin-left: -8%;">
		 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
		 ...
		 <span class="nav-link-text ms-1">Api Key</span>
          ...
          <li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a class="nav-link" href="/settings/callback" style="list-style-type: none; margin-left: -8%;">
		  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
		   <svg class="text-dark" width="16px" height="16px" viewBox="0 0 42 42" version="1.1"
	 	    xmlns="http://www.w3.org/2000/svg"
		     xmlns:xlink="http://www.w3.org/1999/xlink">
		   ...
		   <span class="nav-link-text ms-1">Callback</span>
		 </a>','url' => ['/settings/callback']],
            ],
            'encodeLabels' => false,
            'options' => ['class' =>'nav-link']
          ]); ?> </li>
	   <li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a class="nav-link" href="/settings/whitelist" style="list-style-type: none; margin-left: -8%;">
		 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
		  <svg class="text-dark" width="16px" height="16px" viewBox="0 0 42 42" version="1.1"
		   xmlns="http://www.w3.org/2000/svg"
		    xmlns:xlink="http://www.w3.org/1999/xlink">
		 ...
		 <span class="nav-link-text ms-1">Whitelist</span>
		</a>','url' => ['/settings/whitelist']],
            ],
            'encodeLabels' => false,
            'options' => ['class' =>'nav-link']
          ]); ?> </li>
        ...
        <li class="nav-item"> <?= yii\widgets\Menu::widget([
            'items' => [
                ['label' => '<a class="nav-link" href="/site/logout" style="list-style-type: none; margin-left: -8%;">
		 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="sidenav-footer mx-3 ">
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        ...
        <div class="card-body text-start p-3 w-100">
          ...
          <div class="docs-info">
            <!-- <h6 class="text-white up mb-0">Developers</h6> -->
            <p class="text-xs font-weight-bold">Check our regulatory documents</p>
            <a href="/compliance/index" class="btn btn-white btn-sm w-100 mb-0">Documentation</a>
          </div>
        </div>
      </div>
      <a class="btn bg-gradient-primary mt-3 w-100" target="_blank" href="mailto:info@investbantu.com">Contact Us</a>
    </div>
  </aside>
