  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-monospace text-dark active" aria-current="page">Investments</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Investments</h6>
        </nav>
	...
	'model' => $model,
		...
		'contentOptions' => ['class' => 'text-dark text-sm font-weight-small mb-0'],
              'headerOptions' => ['class' => 'text-uppercase text-secondary text-xxs font-weight-bolder opacity-7'],
	         'value' => function ($model) {
	          return $model['currency'].' '.$model['comm'];                                                                                                                                      }
              ],
	     [
              'attribute' => 'response',
              'contentOptions' => ['class' => 'text-dark text-sm font-weight-small mb-0'],
              'headerOptions' => ['class' => 'text-dark text-sm font-weight-small mb-0'],
             ],
             [
                 'label' => 'Date Created',
                'contentOptions' => ['class' => 'text-dark text-sm font-weight-small mb-0'],
		...
		'contentOptions' => ['class' => 'text-dark text-sm font-weight-small mb-0'],
              'headerOptions' => ['class' => 'text-uppercase text-secondary text-xxs font-weight-bolder opacity-7'],
                 'value' => function ($model) {
                     $date = new DateTime();
                     $date->setTimezone(new DateTimeZone('Africa/Nairobi'));
                     $date->setTimestamp($model['updateTime']/1000);
                     return $date->format('Y-m-d H:i:s');
		 }
              ],
	       ],
